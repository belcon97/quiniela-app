...
export const RULES_STEPS: RuleStep[] = [
  {
    ...
    description:    'Ganás +1 PT por acertar el ganador del partido o el empate, sin necesidad de acertar el marcador exacto.',
  },
  {
    id:             2,
    badge:          '+3\nPTS',
  ...
  },
  {
    ...
    title:          'COMODÍN',
    description:    'Podés usar el comodín una sola vez durante todo el torneo. Duplica los puntos obtenidos en ese partido.',
  },
  {
    id:             4,
    badge:          '+3\nPTS',
    ...
    description:    'Si acertás el goleador del torneo al inicio de la quiniela, sumás 3 puntos adicionales.',
  },
  {
    id:             5,
    badge:          '⚖️',
