      ...
      <View style={containerStyle}>
        <ScrollView contentContainerStyle={styles.rules__scroll}>
          ...
          <View style={styles.rules__header}>
            ...
            <Text style={styles.rules__subtitle}>
              PUNTUACIÓN Y FUNCIONAMIENTO
            </Text>
          </View>
          ...
          <View style={styles.rules__section}>
            ...
            <View style={styles.rules__card}>
              <View style={[styles.rules__badge, styles.rules__badge__yellow]}>
                <Text
                  style={[
                    styles.rules__badgeText,
                    styles.rules__badgeText__yellow,
                  ]}
                >
                  +1{"\n"}PT
                </Text>
              ...
              <View style={styles.rules__cardContent}>
                ...
                <Text style={styles.rules__cardDesc}>
                  Acertás el ganador del partido o el empate, pero no el
                  resultado exacto.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.rules__card}>
              <View style={[styles.rules__badge, styles.rules__badge__green]}>
                <Text
                  style={[
                    styles.rules__badgeText,
                    styles.rules__badgeText__green,
                  ]}
                >
                  +3{"\n"}PTS
                </Text>
            ...
            <View style={styles.rules__card__wildcard}>
              ...
              <Text style={styles.rules__wildcardDesc}>
                Podés usar el comodín una sola vez durante todo el torneo.
          ...
          <View style={styles.rules__section}>
            <View style={styles.rules__empates}>
              <Text style={styles.rules__empatesLabel}>
          ...
          <View style={styles.rules__section}>
            ...
            <Text style={styles.rules__body}>
              A partir de cuartos de final, el resultado válido incluye el
              tiempo extra. Si el partido continúa empatado en tiempo extra, se
              considera empate — los penales no cuentan.
            </Text>
            ...
            <View style={styles.rules__warning}>
              ...
              <Text style={styles.rules__warningText}>
                Los pronósticos para cada fase eliminatoria deben enviarse con
                al menos 24 horas de anticipación al primer partido de esa fase.
              </Text>
            </View>
          </View>
        </ScrollView>
